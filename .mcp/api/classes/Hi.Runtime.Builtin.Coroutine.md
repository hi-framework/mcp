---
fqcn: Hi\Runtime\Builtin\Coroutine
type: class
namespace: Hi\Runtime\Builtin
module: Runtime
file: src/Runtime/Builtin/Coroutine.php
line: 11
---
# Coroutine
...
**文件**: `src/Runtime/Builtin/Coroutine.php:11`
...
| 属性 | 类型 | 可见性 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `$context` | `?Hi\Runtime\ContextInterface` | private | 'null' |  |
