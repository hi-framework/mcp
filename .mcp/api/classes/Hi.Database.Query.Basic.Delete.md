---
fqcn: Hi\Database\Query\Basic\Delete
type: class
namespace: Hi\Database\Query\Basic
module: Database
file: src/Database/Query/Basic/Delete.php
line: 11
---
# Delete
...
**文件**: `src/Database/Query/Basic/Delete.php:11`

## 继承关系

**继承**: `Hi\Database\Query\Basic\DMLBuilder`

**实现**: `Aura\SqlQuery\Common\DeleteInterface`
